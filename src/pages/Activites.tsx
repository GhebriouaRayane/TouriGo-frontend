            ...
            <TabsList className="w-full bg-white/95 backdrop-blur-md p-1 rounded-2xl shadow-lg flex gap-1 overflow-x-auto justify-start">
              {activityTypes.map((type) => (
                <TabsTrigger
                  key={type.id}
                  value={type.id}
                  className="rounded-xl data-[state=active]:bg-primary data-[state=active]:text-white transition-all whitespace-nowrap px-4"
                >
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-border mt-auto">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="font-bold">{formatListingRating(activity, t("common.notAvailable"))}</span>
                      </div>
