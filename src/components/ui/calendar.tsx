    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100 sm:h-8 sm:w-8",
        ),
        ...
        head_row: "",
        head_cell:
          "h-7 p-0 text-center align-middle text-xs font-medium text-muted-foreground sm:h-9 sm:text-sm",
        row: "",
        cell: cn(
          "relative h-8 p-0 text-center align-middle text-sm focus-within:relative focus-within:z-20 sm:h-11 sm:text-base [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day: cn(
          ...
          "mx-auto h-8 w-8 rounded-md p-0 font-normal aria-selected:opacity-100 sm:h-10 sm:w-10",
        ),
        day_range_start:
