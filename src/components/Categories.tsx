...
export default function Categories() {
  const categories = [
    {
      icon: Home,
      iconColor: "text-[#7C99B0]",
      bgColor: "bg-[#7C99B0]/10",
      borderColor: "border-[#7C99B0]/20",
      hoverBg: "hover:bg-[#7C99B0]/5",
      title: "Immobilier",
    ...
    {
      icon: Car,
      iconColor: "text-[#3A6080]",
      bgColor: "bg-[#3A6080]/10",
      borderColor: "border-[#3A6080]/20",
      hoverBg: "hover:bg-[#3A6080]/5",
      title: "Véhicules",
    ...
    {
      icon: Sparkles,
      iconColor: "text-[#5481A0]",
      bgColor: "bg-[#5481A0]/10",
      borderColor: "border-[#5481A0]/20",
      hoverBg: "hover:bg-[#5481A0]/5",
      title: "Activités",
